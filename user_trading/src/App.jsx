...
function App() {
  ...
  return (
    <>
      ...
      {/* Every route below is behind the session check. bootLoading is the
          /getProfile request still in flight — the guard waits for it rather
          than treating "no user yet" as "signed out". */}
      <RequireAuth checking={bootLoading}>
        <Routes>
          ...
          <Route
            path="/livemarket"
            element={<PagesLayout page="livemarket" />}
          />
