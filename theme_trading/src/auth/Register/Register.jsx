...
const Register = () => {
  ...
  return (
    <div className="lp-root">
      {/* Crypto illustration background */}
          ...
          <div className="lp-card-head">
            <span className="lp-hex" aria-hidden="true">
              <svg viewBox="0 0 48 48" fill="none">
                ...
                />
                <path
                  d="M15 34c0-4.4 4-8 9-8s9 3.6 9 8"
                  stroke="#12e0a3"
                  strokeWidth="2"
                  strokeLinecap="round"
                />
            ...
            <div className="lp-head-text">
              <span className="lp-welcome">Create Account</span>
              <h1 className="lp-title">Register</h1>
              <p className="lp-subtitle">
                Join Nexa and start your trading journey
              </p>
            </div>
          </div>
              ...
              <div className="lp-input-wrap">
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M3 5a2 2 0 012-2h2.28a2 2 0 011.94 1.515l.516 2.064a2 2 0 01-.45 1.89l-1.274 1.274a16 16 0 006.586 6.586l1.274-1.274a2 2 0 011.89-.45l2.064.516A2 2 0 0119 16.72V19a2 2 0 01-2 2h-1C8.82 21 3 15.18 3 8V7a2 2 0 010-2z"
                  />
                </svg>
                <input
                  type="tel"
          ...
          <div className="lp-socials">
            ...
            <button type="button" className="lp-social">
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
                style={{ width: "20px", height: "20px", color: "#f8fafc" }}
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
